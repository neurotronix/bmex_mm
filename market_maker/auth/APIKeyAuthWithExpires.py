...
class APIKeyAuthWithExpires(AuthBase):
    ...
    This implementation uses `expires`."""
    ...
    def __call__(self, r):
        ...
        This call uses `expires` instead of nonce.

        This way it will not collide with other processes using the
        same API Key if requests arrive out of order. For more details,
        see https://www.bitmex.com/app/apiKeys
        """
